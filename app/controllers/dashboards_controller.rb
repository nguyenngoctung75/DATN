class DashboardsController < ApplicationController
  ...
  def load_dashboard_data(project)
    ...
    if start_time
      ...
      test_results_scope = test_results_scope.where(
'test_results.executed_at >= :time OR (test_results.executed_at IS NULL AND test_results.created_at >= :time)', time: start_time)
    end
